...
Atualizar texto e assinatura remetente

    ${text_last_doc_last_rem}    Get Text    //body
    ${contain_doc_assinado}    Should Contain    ${text_last_doc_last_rem}    Documento assinado eletronicamente por
    IF    ${contain_doc_assinado} == None
...
Atualizar texto e assinatura receptor

    ${text_last_doc_atual}    Get Text    //body
    ${contain_doc_assinado}    Should Contain    ${text_last_doc_atual}    Documento assinado eletronicamente por
    IF    ${contain_doc_assinado} == None
...
Visualizar processos e extrair informações adicionais
    ...
    FOR    ${file}    IN    @{ListNaoVis}
        ...
        ELSE
            ...
            Save JSON to file    ${all_data}    ${Dir_NaoVisualizados}/${file}
            #Run Keyword and Continue on Failure    Atualizar texto e assinatura remetente
            ${text_last_doc_last_rem}    Get Text    //body
        ...
        ELSE
            ...
            #Run Keyword and Continue on Failure    Atualizar texto e assinatura receptor
            ${text_last_doc_atual}    Get Text    //body
